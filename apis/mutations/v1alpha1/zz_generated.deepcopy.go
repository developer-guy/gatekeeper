...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModifyImageTagToDigest) DeepCopyInto(out *ModifyImageTagToDigest) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ObjectMeta.DeepCopyInto(&out.ObjectMeta)
	in.Spec.DeepCopyInto(&out.Spec)
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModifyImageTagToDigest.
func (in *ModifyImageTagToDigest) DeepCopy() *ModifyImageTagToDigest {
	if in == nil {
		return nil
	}
	out := new(ModifyImageTagToDigest)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ModifyImageTagToDigest) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModifyImageTagToDigestList) DeepCopyInto(out *ModifyImageTagToDigestList) {
	*out = *in
	out.TypeMeta = in.TypeMeta
	in.ListMeta.DeepCopyInto(&out.ListMeta)
	if in.Items != nil {
		in, out := &in.Items, &out.Items
		*out = make([]ModifyImageTagToDigest, len(*in))
		for i := range *in {
			(*in)[i].DeepCopyInto(&(*out)[i])
		}
	}
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModifyImageTagToDigestList.
func (in *ModifyImageTagToDigestList) DeepCopy() *ModifyImageTagToDigestList {
	if in == nil {
		return nil
	}
	out := new(ModifyImageTagToDigestList)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyObject is an autogenerated deepcopy function, copying the receiver, creating a new runtime.Object.
func (in *ModifyImageTagToDigestList) DeepCopyObject() runtime.Object {
	if c := in.DeepCopy(); c != nil {
		return c
	}
	return nil
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModifyImageTagToDigestParameters) DeepCopyInto(out *ModifyImageTagToDigestParameters) {
	*out = *in
	if in.PathTests != nil {
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModifyImageTagToDigestParameters.
func (in *ModifyImageTagToDigestParameters) DeepCopy() *ModifyImageTagToDigestParameters {
	if in == nil {
		return nil
	}
	out := new(ModifyImageTagToDigestParameters)
	in.DeepCopyInto(out)
	return out
}

// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *ModifyImageTagToDigestSpec) DeepCopyInto(out *ModifyImageTagToDigestSpec) {
	*out = *in
	if in.ApplyTo != nil {
		in, out := &in.ApplyTo, &out.ApplyTo
		*out = make([]match.ApplyTo, len(*in))
...
// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new ModifyImageTagToDigestSpec.
func (in *ModifyImageTagToDigestSpec) DeepCopy() *ModifyImageTagToDigestSpec {
	if in == nil {
		return nil
	}
	out := new(ModifyImageTagToDigestSpec)
	in.DeepCopyInto(out)
	return out
}
